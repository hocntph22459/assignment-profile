...
const navbar = () => {
  ...
  return `
            ...
            <a href="/" class="flex items-center">
                <img src="./public/hocclnh.png" class="h-6 mr-3 sm:h-9" alt="Flowbite Logo" />
    ...
    return `
                    <li>
                    <button data-id="${nav.id}" id="btn-cate" class="block py-2 pl-3 pr-4 text-[18px] text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">${nav.name}</button>
                  </li>
                    `
  }).join("")}
          </ul>
